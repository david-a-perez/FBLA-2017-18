...
router.post('/setteachercheckoutlength', async (req, res) => {
...
router.post('/setstudentcheckoutlength', async (req, res) => {
...
router.post('/setteacheroverduefee', async (req, res) => {
...
router.post('/setstudentoverduefee', async (req, res) => {
...
router.post('/setteachermaxbooks', async (req, res) => {
...
router.post('/setstudentmaxbooks', async (req, res) => {
